...
C
            if (Searstr (15, '*ELEMENT, TYPE=CPS4, ELSET=UEL')) then
...
C
     ...
     & 'ComponentName0="E11" ComponentName1="E22" ComponentName2="E33" ComponentName3="E12" format="ascii">'
      DO i=1, NELEMS
            write(16, '(4(E20.13, 1X))') resElem(i, 1), resElem(i, 2), 0.0d0, resElem(i, 3)
      END DO
      write(16, '(a12)') '</DataArray>'
C
     ...
     & 'ComponentName0="S11" ComponentName1="S22" ComponentName2="S33" ComponentName3="S12" format="ascii">'
      DO i=1, NELEMS
            write(16, '(4(E20.13, 1X))') resElem(i, 4), resElem(i, 5), 0.0d0, resElem(i, 6)
      END DO
      write(16, '(a12)') '</DataArray>'
C
      write(16, '(a62, a38)') '<DataArray type="Float32" Name="S_Inv" NumberOfComponents="1" ',
     & 'ComponentName0="MISES" format="ascii">'
      DO i=1, NELEMS
            write(16, '(4(E20.13, 1X))') resElem(i, 7)
      END DO
      write(16, '(a12)') '</DataArray>'
C
