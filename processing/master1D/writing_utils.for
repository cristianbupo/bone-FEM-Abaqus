...
!     PointData
      ...
      call writeDataArrayReal('C', mNod(:, 1+dim:2+dim), NUMNODE, 2)
      call writeDataArrayReal('CMI', mNod(:, 5), NUMNODE, 1)
      call writeDataArrayReal('BorderNode', mNod(:, 6), NUMNODE, 1)
      call writeDataArrayReal('Dummy', mNod(:, 7), NUMNODE, 1)
...
!     TODO: Read numComp from size
      ...
      DO i=1,numElements
         DO j=1,numComp
            write(16,'(E20.13,1X)', advance="no") dataArray(i,j)
         END DO
         write(16, *)
      END DO
